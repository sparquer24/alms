...
const SuccessModal: React.FC<SuccessModalProps> = ({
  ...
  return (
    ...
    >
      <div className={`bg-gradient-to-br from-white via-green-50 to-emerald-50 rounded-2xl shadow-2xl max-w-md w-full mx-4 p-8 relative transform transition-all duration-500 ${
        ...
        <h2 className={`text-2xl font-bold text-center bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent mb-3 transform transition-all duration-500 delay-200 ${
        ...
        {/* Message */}
        <p className={`text-gray-600 text-center mb-6 leading-relaxed transform transition-all duration-500 delay-300 ${
          showContent ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
        }`}>
          {message}
        </p>
        ...
        {applicationId && (
          <div className={`bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4 mb-6 relative overflow-hidden transform transition-all duration-500 delay-400 ${
            showContent ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
          }`}>
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-10 left-10 w-2 h-2 bg-yellow-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: '0.1s' }}></div>
          <div className="absolute top-16 right-12 w-2 h-2 bg-pink-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: '0.3s' }}></div>
          ...
          <div className="absolute bottom-24 right-6 w-2 h-2 bg-green-400 rounded-full animate-bounce opacity-60" style={{ animationDelay: '0.7s' }}></div>
        </div>
      </div>
    </div>
  );
