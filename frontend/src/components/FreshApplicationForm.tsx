    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="sticky top-0 z-40 bg-white shadow-sm border-b border-gray-200">
          <div className="bg-gradient-to-r from-[#022258] to-[#1e3a8a] px-6 py-3">
            <div className="flex items-center justify-between">
              <BackButton />
              <h1 className="text-white font-bold text-2xl flex-1 text-center">
              ...
              <div className="w-full overflow-x-auto bg-gradient-to-r from-[#022258] to-[#1e3a8a] scrollbar-hide">
                ...
                {formSteps.map((section, index) => (
                  <button
                    ...
                    className={`relative px-2 py-2 text-xs font-medium whitespace-nowrap transition-all duration-300 rounded-lg transform hover:scale-105 ${
                      formStep === index
