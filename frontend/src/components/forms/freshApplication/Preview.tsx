...
const Preview = () => {
  ...
  const renderBiometricInfo = () => {
    ...
    const hasBiometricData = biometricData && (biometricData.fingerprints?.length > 0 || biometricData.photo);
        ...
        {hasBiometricData ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              {biometricData.fingerprints && biometricData.fingerprints.length > 0 ? (
              ...
              {biometricData.photo ? (
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-32 h-40 bg-white rounded-lg overflow-hidden border-2 border-gray-200 shadow-sm mb-3">
                    ...
                    {biometricData.photo.url ? (

                      <img 

                        src={biometricData.photo.url} 
                  ...
                  <div className="text-sm text-gray-600">
                    ...
                    {biometricData.photo.fileName || 'Photograph'}
