...
export default function PublicApplicationView({ applicationId, type }: PublicApplicationViewProps) {
  ...
  useEffect(() => {
    const fetchApplication = async () => {
      ...
      try {
        const response = await PublicApi.getApplicationDetails(applicationId, type);
            ...
            <div className='flex items-center gap-3'>
              ...
              <div>
                <h1 className='text-xl font-bold'>
                  {type === 'renewal' ? 'Renewal License Application' : 'Arms License Application'}
                </h1>
            ...
            {application.almsLicenseId && (
              <div className='md:col-span-2'>
                <p className='text-sm text-gray-500 font-medium'>
                  {type === 'renewal' ? 'Renewal License ID' : 'License ID'}
                </p>
