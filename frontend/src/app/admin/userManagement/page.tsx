			...
			<div className="flex-1 p-4">
				<div className="flex-1 flex flex-col min-h-screen">
					<main className="flex-1 flex flex-col items-center justify-start p-0 md:pt-6 md:pl-0 w-full">
						<h1 className="text-2xl md:text-3xl font-bold mb-6 md:mb-8 text-blue-900 w-full max-w-8xl md:max-w-8xl px-4 md:px-0">
							User Management
						</h1>
						{/* Add User & Bulk Upload Buttons */}
						<div className="flex gap-3 mb-4 w-full max-w-8xl md:max-w-8xl justify-end">
							<button
						...
						<div className="flex flex-col md:flex-row gap-3 mb-4 w-full max-w-8xl md:max-w-8xl">
							<input
								type="text"
