  ...
  if (isLoading) {
    return (
      <div className='flex h-screen w-full bg-gray-50'>
        <Sidebar />
        <div className='flex-1 p-8 overflow-y-auto ml-0 md:ml-72 mt-[64px] md:mt-[102px]'>
    ...
    <div className='flex h-screen w-full bg-gray-50 font-[family-name:var(--font-geist-sans)]'>
      ...
      <main className='flex-1 p-8 overflow-y-auto ml-0 md:ml-72 mt-[64px] md:mt-[102px]'>
          ...
          <div className='bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-8'>
            <div className='text-white'>
              ...
              <p className='text-blue-100 text-lg'>
                Manage application workflows and approval processes
              </p>
            </div>
          </div>
        ...
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          {/* Show workflow count */}
          <div className='mb-6'>
            <p className='text-gray-600'>Showing {filteredWorkflows.length} workflow(s)</p>
          </div>
