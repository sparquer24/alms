  ...
  if (error || !request) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 p-8">
        <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-10 max-w-lg w-full text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Cancel Request Not Found</h2>
          <p className="text-gray-500 text-sm mb-6">
            {error || `No cancel request with ID #${id} exists in the system.`}
          </p>
          <a
            href="/inbox"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#001F54] hover:bg-[#012a73] text-white rounded-lg font-medium text-sm transition-colors shadow-sm"
          >
