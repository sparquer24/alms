...
export default function CancelFormDetailClient() {
  ...
  return (
    <div className='p-6 md:p-8 space-y-6 max-w-7xl mx-auto w-full bg-slate-50/50 min-h-screen font-[family-name:var(--font-geist-sans)]'>
      ...
      {/* Workflow & Actions and Cancellation History side-by-side */}
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        {/* Workflow & Actions Card (Actions) */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col">
          {canTakeAction ? (
            ...
            <div className='bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-lg shadow-sm h-full flex items-start'>
        ...
        {/* Cancellation History Card (History) */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col">
          <h3 className='text-lg font-bold text-gray-800 uppercase tracking-wider mb-6 border-b border-gray-100 pb-2 flex items-center gap-2'>
