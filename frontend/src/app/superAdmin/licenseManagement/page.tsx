  ...
  return (
    <div className='flex flex-col flex-grow min-h-0'>
      <PageSubHeader
        ...
        metaBadge={`${filteredLicenses.length} License${filteredLicenses.length !== 1 ? 's' : ''} (Global Access)`}
        actions={
      ...
      <div className='p-4 sm:p-6 lg:p-8 max-w-7xl w-full mx-auto flex flex-col gap-6 flex-grow'>
        <AdminTableContainer
          title='All Licenses'
          description='Global view of all licenses in the system'
        ...
        <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 flex-shrink-0'>
          <p className='text-sm text-blue-800'>
            <strong>Note:</strong> Super Admin has global access to all licenses. To create renewals or cancel licenses, use the appropriate user workflows.
          </p>
        </div>
      </div>
    </div>
