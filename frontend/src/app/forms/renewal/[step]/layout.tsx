...
function LayoutSkeleton() {
  return (
    <div className='relative min-h-screen flex flex-col overflow-x-hidden bg-[#eef2f9]'>
      ...
      >
        <div className='rounded-2xl bg-white border border-blue-100 shadow-xl w-full max-w-[1600px] p-6 animate-pulse'>
...
function RenewalApplicationLayoutContent({
  ...
  return (
    <div className='relative min-h-screen flex flex-col overflow-x-hidden bg-[#eef2f9]'>
      ...
      >
        <div
          className='rounded-2xl bg-white border border-blue-100 shadow-xl w-full max-w-[1600px] flex flex-col p-0 animate-step-transition'
          key={pathname || ''}
        >
          {children}
        </div>
