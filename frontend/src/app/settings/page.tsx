                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="p-2 bg-gray-100 rounded">{role?.name} ({role?.code})</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Can Access Settings</label>
                      <p className="p-2 bg-gray-100 rounded">{role?.can_access_settings ? 'Yes' : 'No'}</p>
                    </div>
                    <div>
