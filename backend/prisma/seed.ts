...
async function main() {
  ...
  const roles = [
    ...
    { code: 'ACO', name: 'Assistant Compliance Officer', dashboardTitle: 'ACO Dashboard', menuItems: ['inbox', 'sent', 'closed'], permissions: ['read'], canAccessSettings: false, canForward: true, canReEnquiry: false, canGenerateGroundReport: false, canFLAF: true, canCreateFreshLicence: true },
    ...
    { code: 'STORE', name: 'Store Superintendent', dashboardTitle: 'STORE Dashboard', menuItems: [], permissions: [], canAccessSettings: false, canForward: true, canReEnquiry: false, canGenerateGroundReport: false, canFLAF: true, canCreateFreshLicence: true },
    { code: 'TL', name: 'Traffic License Superintendent', dashboardTitle: 'TL Dashboard', menuItems: [], permissions: [], canAccessSettings: false, canForward: true, canReEnquiry: false, canGenerateGroundReport: false, canFLAF: true, canCreateFreshLicence: true }
  ];
